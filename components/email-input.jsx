...
const EmailInput = (props) => (
    <form className="grid grid-cols-1 md:grid-cols-3 gap-2" onSubmit={props.onSubmit}>
        ...
        <button className="text-sm font-semibold text-white bg-custom-primary-blue hover:bg-custom-secondary-paleBlue active:bg-custom-secondary-lightRed hover:text-custom-primary-blue active:text-white py-3 rounded-full" type="submit">
            Notify Me
        </button>
    </form>
)
